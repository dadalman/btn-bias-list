      ...
      >
        <div className="px-10 md:px-30 w-auto md:w-[950px] sm:w-[556px] p-4 bg-[#01274F] shadow-[0px_4px_10px_rgba(0,0,0,0.5),_-0px_4px_10px_rgba(0,0,0,0.5)] flex flex-col items-center text-center">
          ...
          <p className="font-inter text-[16px] md:text-[18px] text-[#F4FAFE] mb-6">
            When the final announcement was made, the boys didn’t get to say
            goodbye. <br /> No final bow. No group hug under the lights.
          </p>

          <p className="font-inter text-[16px] md:text-[18px] text-[#F4FAFE] mb-6">
            Just silent shuffles into separate cars — cars that would take them
            away, to the opposite direction of where they wanted to stay.
          </p>
