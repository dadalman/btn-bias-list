...
const TopRankFrame: React.FC<TopRankFrameProps> = ({ name, rank, image }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-[250px] py-1 bg-[#01274F] text-[#F4FAFE] rounded-lg">
      ...
      {/* Clickable Circle */}
      <button className="w-[85px] h-[85px] md:w-32 md:h-32 bg-[#92D0F3] rounded-full flex items-center justify-center shadow-lg mb-2">
        <img
          src={image}
          alt={name}
